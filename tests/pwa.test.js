...
test('Al activar una versión nueva, las pestañas abiertas se actualizan',async()=>{const r=runtime();await r.lifecycle('install');await r.lifecycle('activate');assert.deepEqual(r.navigated,['https://colegio.example/juegos/claret/']);});
